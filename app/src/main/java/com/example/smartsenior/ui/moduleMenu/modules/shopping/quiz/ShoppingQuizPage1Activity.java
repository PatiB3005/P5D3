...
public class ShoppingQuizPage1Activity extends AppCompatActivity {
    ...
    private void setupQ1() {
        groupQ1.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            feedbackQ1.setText(
                    checkedId == R.id.q1_b ?
                            "✓ Dobrze! Sprawdzenie certyfikatu to najlepsza metoda." :
                            "✗ Niepoprawnie. HTTPS nie wystarczy – kliknij kłódkę."
            );
    ...
    private void setupQ2() {
        groupQ2.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            feedbackQ2.setText(
                    checkedId == R.id.q2_c ?
                            "✓ Dobrze! Fałszywy adres to bardzo mocny sygnał oszustwa." :
                            "✗ Niepoprawnie. Najgroźniejsza jest nieistniejąca lokalizacja."
            );
