...
public class AiTheory4Activity extends BaseTTSActivity {
    ...
    private void setupImageZooms() {
        ImageButton zoomLeft = findViewById(R.id.btnZoomLeft);
        ImageButton zoomRight = findViewById(R.id.btnZoomRight);

        if (zoomLeft != null) {
            zoomLeft.setOnClickListener(v -> showImagePreview(R.drawable.kon));
        }

        if (zoomRight != null) {
            zoomRight.setOnClickListener(v -> showImagePreview(R.drawable.phot2));
        }
    }
