...
public class Website3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_website_3);
        ...
        btnFake.setOnClickListener(v -> handleAnswer(false)); // klik FAŁSZYWA = błąd
        btnReal.setOnClickListener(v -> handleAnswer(true));  // klik PRAWDZIWA = dobrze

        btnNext.setOnClickListener(v ->
                startActivity(new Intent(this, Website4Activity.class))
        );
